...
$GLOBALS['TL_DCA']['tl_pct_customcatalog_feed'] = array(
	...
	// Palettes
	'palettes' => array(
		'default'                  	  => '{title_legend},title,alias,language;{configs_legend},configs,jumpTo;{export_legend},titleField,publishedField,descriptionField,authorField,imageField;{config_legend},format,maxItems,feedBase,description;'
	),
	// Fields
	'fields' => array(
		'id' => array(
		...
		'title' => array(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pct_customcatalog_feed']['title'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
		...
		'alias' => array(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pct_customcatalog_feed']['alias'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
		...
		'language' => array(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pct_customcatalog_feed']['language'],
			'exclude'                 => true,
			'search'                  => true,
			'filter'                  => true,
			'inputType'               => 'text',
		...
		'format' => array(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pct_customcatalog_feed']['format'],
			'default'                 => 'rss',
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'select',
		...
		'maxItems' => array(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pct_customcatalog_feed']['maxItems'],
			'default'                 => 25,
			'exclude'                 => true,
			'inputType'               => 'text',
		...
		'feedBase' => array(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pct_customcatalog_feed']['feedBase'],
